...
$patterns = [ordered]@{
  ...
  evidence_exhaustion = @('evidence_exhaustion', 'evidence exhaustion', 'evidence digest', 'negative_searches', 'negative searches', 'not_read_open_gap', 'not read open gap', 'rg alone', 'search exhaustion', 'context window', 'context compression', 'context compressed', '\bcompressed\b', '\bresumed\b.*\b(rg|ripgrep|search)', '\b(rg|ripgrep|search)\b.*\b(no evidence|found no evidence|nothing found|no matches|not found)', '\b(no evidence|found no evidence|nothing found|no matches|not found)\b.*\b(rg|ripgrep|search)', 'systemerror', 'crashpad', 'evidence not fully read', '\u8bc1\u636e.*\u6ca1\u8bfb\u5b8c', '\u8bc1\u636e.*\u7a77\u5c3d', '\u538b\u7f29.*\u8bc1\u636e', '\u538b\u7f29.*rg', 'rg.*\u627e\u4e0d\u5230', '\u627e\u4e0d\u5230.*rg', '\u627e\u4e0d\u5230.*\u4e0d\u7b49\u4e8e')
